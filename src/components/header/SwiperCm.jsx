      ...
      >
        <SwiperSlide>
          <div className={`${styles.img1}`}>
            <div
              className={`grid grid-cols-2 text-white text-2xl ${styles.textup}`}
            >
              <div className=""></div>
              <div className="flex flex-col gap-5 items-center justify-center h-screen">
                <p className="text-3xl font-bold ">GOD OF WAR</p>
                <p className="text-xl font-tanha font-semibold">
                  برای کنسول XBOX و PS
                </p>
                <p className="text-lg font-tanha font-semibold">
                  همین الان خرید کنید
                </p>
